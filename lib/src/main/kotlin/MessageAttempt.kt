...
import com.hooksniff.kotlin.models.EmptyResponse
import com.hooksniff.kotlin.models.ListResponseEndpointMessageOut
import com.hooksniff.kotlin.models.ListResponseMessageAttemptOut
import com.hooksniff.kotlin.models.ListResponseMessageEndpointOut
import com.hooksniff.kotlin.models.MessageAttemptOut
import com.hooksniff.kotlin.models.MessageStatus
import com.hooksniff.kotlin.models.StatusCodeClass
...
class MessageAttempt(private val client: HookSniffHttpClient) {
    /**
    ...
    suspend fun resend(
        ...
        val url =
            client
                .newUrlBuilder()
                .encodedPath("/v1/webhooks/$msgId/endpoint/$endpointId/resend")
